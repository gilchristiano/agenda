...
--
-- Host: 127.0.0.1
-- Generation Time: 21-Jul-2016 às 19:32
...
(1, 'Instituto Federal de Educação, Ciência e Tecnologia Baiano', 'IFBaiano', '0200-12-29', '0000-00-00', 'Lei disponível em http://www.planalto.gov.br/ccivil_03/_ato2007-2010/2008/lei/l11892.htm');
...
--
ALTER TABLE `servidor`
  MODIFY `idServidor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `servidor_setor`
--
ALTER TABLE `servidor_setor`
  MODIFY `idservidor_setor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
