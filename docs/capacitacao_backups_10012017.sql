...
--
-- Host: 127.0.0.1
-- Generation Time: 10-Jan-2017 às 17:12
...
--
-- Estrutura da tabela `registro_servidor`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Registra a posse, remoção ou redistribuição';
...
(10, 'Adelmo', 'Aquino das Neves', '2227308', 'TAE', 'Técnico Administrativo (Poder Executivo)', 'Técnico de Tecnologia da Informação', '1972-03-06', '2015-04-30', '0001-01-01', 'Não constam', 0),
(12, 'Greise', 'Rocha Castro de Oliveira', '9876543', 'EBTT', 'Docente (Poder Executivo)', 'Docente Ensino Básico, Técnico e Tecnológico', '1996-05-27', '2015-10-10', '0001-01-01', 'Nada consta', 0),
(16, 'Maria ', 'Bonita', '58479651', 'TAE', 'Técnico Administrativo (Poder Executivo)', 'Técnica de Assuntos Educacionais', '1990-05-20', '2015-07-02', '0001-01-01', 'Nada consta', 0);
...
(5, 5, 3, '2015-10-10', '0001-01-01', 'Não possui'),
(6, 10, 3, '2015-10-10', '0001-01-01', 'Não possui'),
(7, 12, 3, '2015-10-10', '0001-01-01', 'Não possui'),
(8, 8, 3, '2015-10-10', '0001-01-01', 'Não possui'),
(9, 3, 3, '2015-10-10', '0001-01-01', 'Não possui'),
(10, 7, 1, '2015-10-10', '0001-01-01', 'Não possui');
...
--
-- Indexes for table `registro_servidor`
--
ALTER TABLE `registro_servidor`
  ADD PRIMARY KEY (`codigo`),
  ADD UNIQUE KEY `siape` (`siape`),
  ADD UNIQUE KEY `instituto` (`instituto`);
...
--
ALTER TABLE `servidor`
  MODIFY `idServidor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT for table `servidor_setor`
--
ALTER TABLE `servidor_setor`
  MODIFY `idservidor_setor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
